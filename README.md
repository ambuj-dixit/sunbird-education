...
src/
 ├── assets/
 │    ├── background-images/      # Background slider images (SAMPLE)
 │    └── gallery/                # Gallery sample images
 ├── components/
 │    ├── Header.tsx
 │    ├── Footer.tsx
 │    ├── Hero.tsx
 ...
 │    └── Downloads.tsx
 ├── data/
 │    ├── sampleContent.ts        # All SAMPLE text, images & contact info
 │    └── calendar.ts             # Academic calendar sample data
 ├── layouts/
 │    └── MainLayout.tsx          # Shared header + footer wrapper
 └── App.tsx
...
Classes: LKG to 8th
You can modify this only in the content file if needed.
